        ...
        for i_range in ranges:
                ...
                for i_capID in range(4):
                        ...
                        if shuntMult == -1:
                                ...
                                nominalgraph.SetNameTitle('%s_range_%i_shunt_%i'%(nominalgraph.GetName(),i_range,shuntMult),'%s_range_%i_shunt_%i'%(nominalgraph.GetName(),i_range, shuntMult))
                        ...
                        for i_capID in range(4):
                                ...
                                if i_capID==0:
                                        ...
                                        if shuntMult == -1:
                                                ...
                                                graph.SetTitle("LinADC vs Charge, Range %i, %s, QIE %i,Shunt %i" % (i_range,qieUniqueID,qieNumber,shuntMult))
